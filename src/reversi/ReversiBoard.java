...
public class ReversiBoard extends Board {
    ...
    public void createGrid(GridCreatorVisitor visitor) {
        ...
        pieceLayoutDecorator.getGridContainer().setManaged(false);
        pieceLayoutDecorator.getGridContainer().setLayoutX(BORDER_WIDTH);
        pieceLayoutDecorator.getGridContainer().setLayoutY(BORDER_WIDTH);
        ...
        hBottom.getChildren().add(pieceLayoutDecorator.getGridContainer());

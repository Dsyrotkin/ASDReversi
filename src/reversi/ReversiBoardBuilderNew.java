...
import UI.GameManagerNew;
import framework.board.builder.GameBoardBuilderNew;
...
public class ReversiBoardBuilderNew extends GameBoardBuilderNew {

    GameManagerNew manager;
    GridCreatorVisitor visitor;
    public ReversiBoardBuilderNew(GameManagerNew manager, PieceLayout pieceLayout,
